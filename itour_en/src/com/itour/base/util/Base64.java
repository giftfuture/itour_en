...
/* ********  D E T E R M I N E   W H I C H   A L H A B E T  ******** */
    ...
    public final static void main( String[] args )
    {
       if( args.length < 3 ){
    	...
    	System.out.println(decodeBase64("YWRtaW4="));	
    }   // end main
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    /**
     * encode src to base64 tar
     * if str is empty then return src as result
     * @param src byte[]
     * @return tar String
     * @author  
     */
    public static String encodeBase64(byte[] src) {
        ...
        return encodeBytes(src, Base64.DONT_BREAK_LINES);
    }
    ...
    public static String encodeBase64(String src) {
        ...
        return encodeBytes(src.getBytes(), Base64.DONT_BREAK_LINES);
    }
    
    /**
     * yahoo y64 encode for encoded url
     * replace tar '=' to '-'
     * replace tar '+' to '.'
     * replace tar '/' to '_'
     * @param src String
    ...
    /**
     * decode base64 tar to src
     * if tar is empty then return tar as result
     * @param tar String
     * @return src String
     * @author  
     */
    ...
    /**
     * yahoo y64 decode for encoded url
     * replace tar '-' to '='
     * replace tar '.' to '+'
     * replace tar '_' to '/'
     * @param src String
