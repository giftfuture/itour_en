	...
	var _this = {
		...
		addDefBtns:function(){
			var defaultBtns= [
				...
				{"btnName":"物理删除","menuid":'38E4B204A09D49E89358A1D1D5E463B6',"actionUrls":"quotation/delete","btnType":"remove"}
			];
  			...
  			dataGrid:{
  				title:'报价单',
	   			...
	   			columns:[[
					...
					{field:'quotation',title:'报价单',align:'center',sortable:true,
							formatter:function(value,row,index){
								return row.quotation;
							}
						},
					{field:'createTime',title:'生成时间',align:'center',sortable:true,
							formatter:function(value,row,index){
					...
					{field:'type',title:'总价加利润/明细报价',align:'center',sortable:true,
							formatter:function(value,row,index){
								return row.type;
							}
						},
					{field:'totalPrice',title:'总价',align:'center',sortable:true,
							formatter:function(value,row,index){
								return row.totalPrice;
							}
						},
					{field:'formula',title:'计算明细',align:'center',sortable:true,
							formatter:function(value,row,index){
								return row.formula;
							}
