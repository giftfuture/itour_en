...
/*			$("input[name='children']").numberbox({  
		...
		/*	$("a[name='calculateSum']").click(function(){
				//document.forms["calculatespendForm"].submit();
				var formData = new Object();
				var actionurl=basePath+"travelOrder/toQuote3";
				...
				//	$("a[name='calculateSum']").parents("td").next().next().next().html(result.adultsumcost);
				//	$("a[name='calculateSum']").parents("td").next().next().next().next().html(result.childrensumcost);
					//$("td[name='adultsumcost']").html(result.adultsumcost);
					//$("td[name='childrensumcost']").html(result.childrensumcost);
				});
			});*/
		/*	$("a[name='reviewcalculate']").click(function(){
				var formData = new Object();
				var actionurl=basePath+"travelOrder/toQuote3";
				var id=$("input[type='hidden'][name='id']").val();
				var adults=$("input[name='adults']").val();	
			...
			/*$("a[name='generateQuote']").click(function(){
