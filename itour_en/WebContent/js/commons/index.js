...
itouren.index = function(){
	var _this = {
		...
		init:function(){
			...
			var exchange = "<tr><td style='text-align:center;width:100%;float:middle;' height='33px' ><ol style='margin-top:-3%;padding-left:800px;display:table;text-align:center;width:100%;float:middle'>";
