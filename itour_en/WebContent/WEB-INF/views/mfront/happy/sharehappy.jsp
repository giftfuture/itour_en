...
<table border="0" align="center" width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td  style="float:left;text-align:left;"><img style="float:left" src="images/frame1-1.gif" width="1140" height="7" /></td>
  </tr>
  <tr>
        ...
        <form:form name="sharehappy" method="post" enctype="multipart/form-data" autocomplete="off">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
             ...
             <td rowspan=4 style="vertical-align:top; padding-top:10px;" class="STYLE18">
                    ...
                    <img id="cover" style="border:none;" border="0px" height="200" width="200" /></td></tr> 
             <tr>
