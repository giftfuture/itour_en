...
<div class="frametb" id="tab-container" class='tab-container' width="100%"  style="width:100%;text-align:center;float:middle" >
 ...
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}selfdrive/selfdrive/${alias}#review" target="_self">Overall overview</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}selfdrive/selfdrive/${alias}#detail-route" target="_self">Detailed itinerary</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}selfdrive/selfdrive/${alias}#need-know" target="_self">Before the line to know</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}selfdrive/selfdrive/${alias}#feed-back" target="_self">Client feedback</a></li>
...
<table  class="frametb" align="center">
  <tr>
    <td style="float:left"><img style="float:left" src="images/frame1-1.gif" width="100%" height="7" /></td>
  </tr>
  <tr>
