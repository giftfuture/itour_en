...
<table class="commontb" align="center" width="100%" style="width:100%;text-align:center;float:middle" >
  ...
  <tr>
    ...
    <table style="float:middle;text-align:center;" align="center" valign="top" >
      <tr>      
        <td  style="border:none;width:100%"><div class="bigImage"><img src="${basePath}${rt.cover}" style="border:none;width:100%;float:middle" border="0px" width="100%"/></div></td>
      </tr>
      <tr> <td height="69">
<div align="center">
<!--滚动图片 start-->
...
<div class=box><A class="imgBorder" target="_blank" style="float:left;padding-left:0"><IMG style="float:left;padding-left:0" alt="landscape" src="${basePath }${photo}" border=0/></A> 
</div>
</c:forEach>
<!-- 图片列表 end --></DIV>
     ...
     <table style="text-align:center;float:middle;" align="center">
      <tbody><tr>
        ...
        <tr>
          ...
          <td class="STYLE126" style="float:left;text-align:left">${rt.trekDistance }km</td>
        </tr>
        </c:if>
        <c:if test="${not empty rt.mountStyle}">
        <tr>
          <td class="STYLE126"><div align="right"><strong>Mountain Style</strong></div></td>
          <td class="STYLE126" style="float:left;text-align:left">${rt.mountStyle } <a href="javascript:void(0)" title="${rt.mountStyle}"> </a></td>
        </tr>
        </c:if>
        <tr>
...
<div class="frametb" id="tab-container" class='tab-container' width="100%"  style="width:100%;text-align:center;float:middle" >
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="15%" bgcolor="#F0F0F0" style="margin:-5" class='tab'><a href="${basePath}hiking-${alias}#review" target="_self">Overview</a></li>
   <li width="15%" bgcolor="#F0F0F0" style="margin:-5" class='tab'><a href="${basePath}hiking-${alias}#detail-route" target="_self">RouteDetails</a></li>
   <li width="15%" bgcolor="#F0F0F0" style="margin:-5" class='tab'><a href="${basePath}hiking-${alias}#need-know" target="_self">BeforeInstructions</a></li>
   <li width="15%" bgcolor="#F0F0F0" style="margin:-5" class='tab'><a href="${basePath}hiking-${alias}#show-happy" target="_self">Happiness</a></li>
 </ul>
 ...
 <div id="review" name="review">
  ...
  <tr>
    <td colspan=2 style="text-align:left;float:left;padding-top:30;"><img src="${basePath}images/heart02.png" width="32" height="32" style="float:left;width:32;height:32;" />
    <span class="h2-24" style="text-align:left;float:left;"><span class="STYLE148"><span class="STYLE14"><span class="STYLE2" style="font-size:1em">Service and quotation</span></span></span></span></td>
  </tr>
    <tr>
...
<tr>
  ...
  <tr>
    ...
    <td width="100%" style="text-align:left;float:left" ><span class="h2-24"><span class="STYLE148">
    <span class="STYLE14"><span class="STYLE2" style="text-align:left;float:left;font-size:1em;" >Would you like to know what? Come and talk to us:</span></span></span></span></td>
  </tr>
</table>
<table class="frametb" align="center">
  <tr>
        ...
        <tr>
          ...
          <!--     <tr>
              ...
              <tr>
                ...
                <img alt="Click to replace" style="width:65;height:23" src="${basePath}ImageServlet" id="validateCodeImg" onclick="document.getElementById('validateCodeImg').src='${basePath}ImageServlet?'+Math.random()">
...
<script type="text/javascript" src="${basePath}jsm/ux/front/trek/hiking.js"></script>
</center>
</body>
</html>
