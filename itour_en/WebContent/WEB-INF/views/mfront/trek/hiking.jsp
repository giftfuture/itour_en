...
<tr>
 ...
 <tr>
   ...
   <tr><td><a href="${basePath}hiking/toQuote2/${rt.alias}" class="easyui-linkbutton">预定本路线</a></td></tr>  
<table class="frametb" align="center" width="100%" style="width:100%;text-align:center;float:middle" >  --%>
...
<div class="frametb" id="tab-container" class='tab-container' width="100%"  style="width:100%;text-align:center;float:middle" >
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking/hiking/${alias}#review" target="_self">Overall overview</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking/hiking/${alias}#detail-route" target="_self">Detailed itinerary</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking/hiking/${alias}#need-know" target="_self">Before the line to know</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking/hiking/${alias}#feed-back" target="_self">Client feedback</a></li>
 ...
 <div id="review" name="review">
  ...
  <tr>
    ...
    <td width="100%"   style="text-align:left;float:left;"><span class="h2-24"><span class="STYLE148">Before the line to know</span></span></td>
  </tr>
  <tr>
...
<tr>
  ...
  <tr>
    ...
    <td width="100%" style="text-align:left;float:left" ><span class="h2-24"><span class="STYLE148"><span class="STYLE14"><span class="STYLE2" style="text-align:left;float:left" >Would you like to know what? Come and talk to us:</span></span></span></span></td>
  </tr>
</table>
<table class="frametb" align="center">
  <tr>
