...
<html>
<head>
<title>HotSight trip in detail</title>
...
<div class="frametb" id="tab-container" class='tab-container' border="0" cellpadding="3" cellspacing="1">
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="110" bgcolor="#F0F0F0" class='tab' style="margin:-5"><a href="${basePath}hotsight-${alias}#review">Overview</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab' style="margin:-5"><a href="${basePath}hotsight-${alias}#detail-route">Route Details</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab' style="margin:-5"><a href="${basePath}hotsight-${alias}#need-know">Before Instructions</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab' style="margin:-5"><a href="${basePath}hotsight-${alias}#show-happy">Happiness</a></li>
 ...
 <div id="review">
  ...
  <table  class="frametb" align="center">
  <tr>
    <td  colspan=2 bstyle="text-align:left;float:left;padding-top:30;"><img src="images/document2.png" width="32" height="32" /> 
 ...
 <tr>
  ...
  <tr><td colspan=2 style="float:left" background="images/frame1-2.gif" style="valign:top;"> 
     ...
     <a href="${basePath}hotsight-${relat.alias}" >${relat.title }</a>
  ...
  <table  class="frametb" align="center">
   <tbody><tr>
     <td width="336"  style="text-align:left;float:left;padding-top:30;" ><span class="STYLE3">Tell us your needs, free planning for your program GO! </span> &nbsp;&nbsp;
