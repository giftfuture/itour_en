...
<tr>
        ...
        <tr>
          ...
          <td class="STYLE126" style="float:left;text-align:left">${rt.departure }<a href="javascript:void(0)" title="${rt.departure}"> </a></td>
        </tr>
        <tr>
...
<div class="frametb" id="tab-container" class='tab-container' width="100%"  style="width:100%;text-align:center;float:middle" >
 ...
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="15%" bgcolor="#F0F0F0" class='tab' style="margin:-5"><a href="${basePath}climb-climb-${alias}#review" target="_self">Overview</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab' style="margin:-5"><a href="${basePath}climb-climb-${alias}#detail-route" target="_self">Route Details</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab' style="margin:-5"><a href="${basePath}climb-climb-${alias}#need-know" target="_self">Before Instructions</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab' style="margin:-5"><a href="${basePath}climb-climb-${alias}#feed-back" target="_self">Feedback</a></li>
 ...
 <div id="review" name="review">
  ...
  <table  class="frametb" align="center">
  <tr>
    <td  style="text-align:left;float:left;"><img src="images/document2.png"  style="width:32;height:32;" width="32" height="32" /></td>
  ...
  <tr>
    <td  style="float:left"><img style="float:left" src="${basePath}images/heart02.png" style="width:32;height:32;" width="32" height="32" /></td>
  ...
  <tr>
    <td   style="float:left"><img style="float:left" src="${basePath}images/heart02.png" style="width:32;height:32;" width="32" height="32" /></td>
     <td   style="float:left"><span class="h2-24" style="float:left"><span class="STYLE148"><span class="STYLE14"><span class="STYLE2" style="font-size:1em">Related Routes:</span></span></span></span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="100%" style="text-align:left;float:left" ><span class="h2-24"><span class="STYLE148"><span class="STYLE14"><span class="STYLE2" style="text-align:left;float:left;font-size:1em;" >Would you like to know what? Come and talk to us:</span><a href="#"></a></span></span></span></td>
  </tr>
</table>
<table  class="frametb" align="center">
  <tr>
