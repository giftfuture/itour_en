...
<div class="frametb" id="tab-container" class='tab-container' width="100%"  style="width:100%;text-align:center;float:middle" >
 ...
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="15%" bgcolor="#F0F0F0" class='tab' style="margin:-5"><a href="${basePath}climb-${alias}#review" target="_self">Overview</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab' style="margin:-5"><a href="${basePath}climb-${alias}#detail-route" target="_self">Route Details</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab' style="margin:-5"><a href="${basePath}climb-${alias}#need-know" target="_self">Before Instructions</a></li>
   <li width="15%" bgcolor="#F0F0F0" class='tab' style="margin:-5"><a href="${basePath}climb-${alias}#show-happy" target="_self">Happineess</a></li>
 ...
 <div id="review" name="review">
  ...
  <table  class="frametb" align="center">
  <tr>
    <td  style="text-align:left;float:left;padding-top:30;"><img src="images/document2.png"  style="width:32;height:32;" width="32" height="32" /> 
  ...
  <tr>
    <td colspan=2 style="float:left;padding-top:30;"><img style="float:left" src="${basePath}images/heart02.png" style="width:32;height:32;" width="32" height="32" />
  ...
  <tr>
   <td colspan=2 style="padding-top:30;"><span style="text-align:left;float:left" class="STYLE3">Tell us your needs, free planning for your program GO!</span> &nbsp;&nbsp;
