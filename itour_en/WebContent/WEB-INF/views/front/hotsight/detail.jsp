    ...
    <td width="476" valign="top"><div align="center"><span class="STYLE2">这条线路适合我吗？</span>
      ...
      <table width="442" border="0" cellpadding="4" cellspacing="2" class="STYLE126">
        ...
        <tr>
          ...
          <td class="STYLE126" style="text-align:left">${rt.mountStyle } <a href="javascript:void(0)" title="">Explain&gt;&gt; </a></td>
        </tr>
      </table>
      ...
      <tr>
        ...
        <tr><td>相关路线：
            ...
            <a href="${basePath}hotsight/hotsight/${relat.alias}">${relat.title }</a>
            	<%-- <a href="${basePath}hotsight/toQuote2/${relat.alias}" class="easyui-linkbutton" >${relat.title }</a> --%>
            </c:forEach>
            </td></tr>
...
<!--    <li width="110" bgcolor="#F0F0F0" class='tab'><a href="#consulting">咨询预定</a></li> -->
 ...
 <div id="review">
  ...
  <tr>
    <td style="float:left"><img src="${basePath}images/frame1-1.gif" width="1140" height="7" /></td>
  </tr>
  <tr>
  ...
  <table width="600" border="0" cellspacing="0" cellpadding="0">
   <tbody><tr>
     <td width="336" style="text-align:left"><span class="STYLE3">告诉我们您的需求，免费为您策划方案 GO! </span> 
      <span class="STYLE3" ><a href="${basePath}hotsight/selfbooking/${rt.alias}">
...
<table wwidth="1140" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td style="float:left"><img src="${basePath}images/frame1-1.gif" width="1140" height="7" /></td>
  </tr>
  <tr>
