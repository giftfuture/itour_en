...
<table  id="main-content" class="frametb" align="center"><!--  width="1350px" -->
  ...
  <tr>
    <td width="750"><table width="600" style="float:right;text-align:right;align:right;margin-right:50px;" border="0" cellpadding="0" cellspacing="0">
      <tr><td width="776" style="float:middle" class="h1-black">${rt.title}</td></tr>  
      <tr>
...
<div class="frametb" id="tab-container" class='tab-container' border="0" cellpadding="3" cellspacing="1">
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hotsight-${alias}#review">Overview</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hotsight-${alias}#detail-route">Route Details</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hotsight-${alias}#need-know">Before Instructions</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hotsight-${alias}#show-happy">Happiness</a></li>
