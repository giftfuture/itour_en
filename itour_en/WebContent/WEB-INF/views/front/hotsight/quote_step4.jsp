...
★我们了解您的疑虑，您只負責旅行，其它的交給主角旅行吧。 <br />
      ...
      <span class="STYLE10">备注：酒店的详细价格那一列就不显示了</span><br />
      <br /></td>
  </tr>
  <tr>
    <td><img src="images/frame1-3.gif" width="1140" height="7" /></td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td background="images/frame1-2.gif"><table width="1100" border="0" align="center" cellpadding="10" cellspacing="0">
        <tr>
          <td valign="top"><table width="1100" border="0" align="center" cellpadding="4" cellspacing="2">
            ...
            <tr>
              <td>&nbsp;</td>
              <td><span class="STYLE10">备注：除门票项目外，其它项目都默认不显示这一栏的具体价格，显示项目内容即可<br />
                右边的明细价格只显示“加价之后的价格”，若前一页没选中“报价单中显示明细帐目”则不显示右边那一列。</span></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><label></label>
                  ...
                  <table border="0" cellspacing="0" cellpadding="3">
                    <tr>
                      <td><input type="submit" name="Submit23" value="返回上页修改" /></td>
                      <td><input type="submit" name="Submit223" value="改下项目描述" /></td>
                      <td><input type="submit" name="Submit2223" value="生成正式报价单" /></td>
                    </tr>
                    <tr>
                      <td><a href="${basePath}hiking/toQuote２">链接1</a></td>
                      <td>改下项目描述</td>
                      <td><a href="${basePath}hiking/toQuote1">GO</a></td>
                    </tr>
                </table></td>
              <td>&nbsp;</td>
            </tr>
  ...
  <tr>
    <td><img src="images/frame1-3.gif" width="１００％" height="7" /></td>
  </tr>
</table>
<script type="text/javascript" src="${basePath}js/ux/front/hotsight/quote_step4.js"></script>
