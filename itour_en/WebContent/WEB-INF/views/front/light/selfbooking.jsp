    ...
    <td>  
      <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="heedline1">
        ...
        <tr> 
          ...
          <td style="text-align:left"><input name="expectedDepart" id="expectedDepart" type="text" class='easyui-datebox' data-options="showSeconds:false, width:150,validType:'dateValided',editable:false,split:true,border:false,region:'north',onSelect:itouren.lightselfbooking.onChangeDate(this)" /></td>
        </tr>
        <tr> 
          <td><div align="right"><strong>Expected return date:</strong></div></td>
          <td style="text-align:left"><input id="expectedBack" name="expectedBack" type="text" class='easyui-datebox' data-options="showSeconds:false,width:150,validType:'md[\'#expectedDepart\']',editable:false,split:true,border:false,region:'north',onSelect:itouren.lightselfbooking.onChangeDate(this)" />
            </td>
        </tr>
		<tr> 
