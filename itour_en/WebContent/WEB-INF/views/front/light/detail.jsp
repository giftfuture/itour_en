...
<table  class="commontb" align="center" border="0" cellpadding="10" cellspacing="0">
  <tr>
...
<div class="frametb" id="tab-container" class='tab-container' border="0" cellpadding="3" cellspacing="1">
 <ul class='etabs' style="text-align:left;float:left">
   ...
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}light/light/${alias}#need-know">行前需知</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}light/light/${alias}#feed-back">客户反馈</a></li>
