    ...
    <td> <div align="center"> </div>
      ...
      <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="heedline1">
        ...
        <tr> 
          ...
          <td style="text-align:left"><input name="expectedDepart" id="expectedDepart" type="text" class='easyui-datebox' data-options="showSeconds:false, width:150,validType:'dateValided',editable:false,split:true,border:false,region:'north',onSelect:itouren.selfdriveselfbooking.onChangeDate(this)" /></td>
        </tr>
        <tr> 
          <td><div align="right"><strong>Expected return date:</strong></div></td>
          <td style="text-align:left"><input id="expectedBack" name="expectedBack" type="text" class='easyui-datebox' data-options="showSeconds:false,width:150,validType:'md[\'#expectedDepart\']',editable:false,split:true,border:false,region:'north',onSelect:itouren.selfdriveselfbooking.onChangeDate(this)" />
            </td>
        </tr>
		<tr> 
		  ...
		  The date of the group:<input id="groupDate" name="groupDate" type="text" class='easyui-datebox' data-options="validType:'dateValided',editable:false,required:true,split:true,border:false,region:'north',onSelect:itouren.climbselfbooking.onChangeDate(this)" style="width:100px;" />
		  </span> </td>
        </tr>
        <tr> 
  ...
  <!--  <tr> 
    ...
    <tr> 
        ...
        <td  style="text-align:left"> <input type="text" id="verifyCode" name="verifyCode"  class="easyui-textbox" title="verify Code" data-options="prompt:'please enter verification code!'" />
          <img alt="Click to replace" src="${basePath}RandomCodeServlet" id="validateCode" onclick="itouren.selfdriveselfbooking.changeValidateCode()">
          &nbsp;&nbsp;<a href="javascript:void(0)" onclick="itouren.selfdriveselfbooking.changeValidateCode()">Can not see, change one</a></td>
      ...
      <tr> <td></td>
        <td style="text-align:left;padding-bottom:50px;"><a class="easyui-linkbutton" iconcls="icon-ok"  name="check_formbtn">Quickly book</a></td>
      </tr>
      </table></td>
