...
<div class="frametb" id="tab-container" class='tab-container' border="0" cellpadding="3" cellspacing="1">
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}selfdrive-selfdrive-${alias}#review">Overview</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}selfdrive-selfdrive-${alias}#detail-route">Route Details</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}selfdrive-selfdrive-${alias}#need-know">Before Instructions</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}selfdrive-selfdrive-${alias}#feed-back">Feedback</a></li>
