...
<table  id="main-content" class="frametb" align="center"><!--  width="1350px" -->
  ...
  <tr>
    <td style="width:56.7%;padding-top:30;"><table style="float:right;text-align:right;align:right;margin-right:50px;" border="0" cellpadding="0" cellspacing="0">
      <tr><tdstyle="float:middle" class="h1-black">${rt.title}</td></tr>
      <tr>
        <td name="magnifying">
...
<!--滚动图片 end-->
 ...
 <tr>
  ...
  <table>
<tr><td style="text-align:center;float:middle;">
<div class="frametb" id="tab-container" class='tab-container' border="0" cellpadding="0" cellspacing="0">
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}selfdrive-${alias}#review">Overview</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}selfdrive-${alias}#detail-route">Route Details</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}selfdrive-${alias}#need-know">Before Instructions</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}selfdrive-${alias}#show-happy">Happiness</a></li>
