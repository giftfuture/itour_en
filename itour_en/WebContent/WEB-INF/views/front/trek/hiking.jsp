...
<div class="frametb" id="tab-container" class='tab-container' border="0" cellpadding="3" cellspacing="1">
 <ul style="text-align:left;float:left" class='etabs'>
   ...
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking-${alias}#need-know">Before Instructions</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}hiking-${alias}#show-happy">Happiness</a></li>
 ...
 <div id="review">
  ...
  <table class="frametb" align="center">
  <tr>
    <td  style="text-align:left;padding-top:30;" colspan=2><img src="images/document2.png" width="32" height="32" /> 
