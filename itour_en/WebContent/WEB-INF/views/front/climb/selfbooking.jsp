    ...
    <td> <div align="center"> </div>
      ...
      <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="heedline1">
		...
		<tr> 
		  ...
		  出团日期：<input id="groupDate" name="groupDate" type="text" class='easyui-datebox' data-options="validType:'dateValided',editable:false,required:true,split:true,border:false,region:'north',onSelect:itour.climbselfbooking.onChangeDate(this)" style="width:100px;" />
		  </span> </td>
        </tr>
        <tr> 
  ...
  <!--  <tr> 
    ...
    <tr> 
        ...
        <td  style="text-align:left"> <input type="text" id="verifyCode" name="verifyCode"  class="easyui-textbox" title="验证码" data-options="required:true" nullmsg="请输入验证码!"/>
          <img alt="点击更换" src="${basePath}RandomCodeServlet" id="validateCode" onclick="itour.climbselfbooking.changeValidateCode()">
          &nbsp;&nbsp;<a href="javascript:void(0)" onclick="itour.climbselfbooking.changeValidateCode()">看不清，换一张</a></td>
