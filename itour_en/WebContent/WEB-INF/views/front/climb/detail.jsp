...
<center>
<table class="frametb" align="center"><!--  width="1350px" -->
  <tr>
...
<!--滚动图片 end-->
        ...
        <td width="44.3%" valign="top" > 
    
      <table border="0" cellpadding="0" cellspacing="2" class="STYLE126">
      <tbody><tr>
...
<br />
<br />
<table class="frametb" align="center" id="main-content" ><tr><td>
<div class="frametb" id="tab-container" class='tab-container' border="0" cellpadding="3" cellspacing="1">
 <ul style="text-align:left;float:left" class='etabs'>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}climb-${alias}#review">Overview</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}climb-${alias}#detail-route">Route Details</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}climb-${alias}#need-know">Before Instructions</a></li>
   <li width="110" bgcolor="#F0F0F0" class='tab'><a href="${basePath}climb-${alias}#show-happy">Happiness</a></li>
...
<div id="show-happy" name="show-happy">
  ...
  <table class="frametb" align="center"><tr><td><%@include file="/front/footer.jsp" %></td></tr></table>
