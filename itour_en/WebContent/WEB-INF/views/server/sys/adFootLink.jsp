...
<!-- 	 <div id="upload-photo" title="图片上传" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:420px;display:none;">	 
     ...
     <div id="edit-win" title="页脚链接" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:420px;display:none;">  
     	<form id="editForm" class="ui-form" method="post">  
     		 <input class="hidden" name="id">
     		 <div class="ui-edit">
		     	   <!-- <div class="ftitle">页脚链接</div> -->
...
<script type="text/javascript" src="${basePath}/js/ux/sys/adFootLink.js"></script>		  
  </body>
</html>
