  ...
  <body class="easyui-layout">
 	 ...
 	 <form id="searchForm">
        <p class="ui-fields">
			...
			<label class="ui-label">表名:</label><input name="tableName" class="easyui-textbox" data-options="width:120">&nbsp;&nbsp;
			<label class="ui-label">功能:</label><input name="function" class="easyui-textbox" data-options="width:120">&nbsp;&nbsp;
	    </p>
