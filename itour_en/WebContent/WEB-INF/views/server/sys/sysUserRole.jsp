	...
	<!-- Search panel start -->
 	 ...
 	 <form id="searchForm">
 	 	<p class="ui-fields">
 	 	   ...
 	 	   <input name="email" class="easyui-textbox" data-options="width:120">&nbsp;&nbsp;
            <label class="ui-label">状态: </label><select name="state" class="easyui-combobox" data-options="width:120,editable:false,region:'north',split:true,border:false"><option value="">--请选择--</option><option value=0>可用</option><option value=1>禁用</option></select>&nbsp;&nbsp;
            <label class="ui-label">授予角色: </label><input name="roleStr" class="easyui-combobox"  data-options="width:120,valueField:'number',textField:'roleName',mode:'remote',panelHeight:'auto',editable:false,method:'post',url:'${basePath}sysRole/loadRoleList'">&nbsp;&nbsp;
        </p>
