$package('itouren.mhiking');
itouren.mhiking = function(){
	var _this = {
										...
										html+='<table width="63%" border="0" cellpadding="2" cellspacing="2" class="STYLE126">'+
								              '<tr>'+
								                '<td width="11%"><div align="center"></div>'+
								                  (e.sex||e.sex==1 ? '<img src="images/man.gif" style="width:32;height:32;" width="32" height="32" />':'<img src="images/woman.gif" style="width:32;height:32;" width="32" height="32" />')+
								                '</td><td width="59%" style="text-align:left"><strong>'+(e.customerName?e.customerName:"")+'</strong><span class="STYLE140">'+(e.preferedDate?e.preferedDate:"")+'</span></td>'+
								              '</tr>'+
								              '<tr>'+
								              '<td width="11%">&nbsp;</td>' +
...
$(function(){
	   itouren.mhiking.init();
	   itouren.mhiking.copyUrl();
	   var homeurl = window.location.href;
	   var url = itouren.mhiking.qqFriend();  
       $("#qq_id").attr("href",url); 
});
