$package('itouren.mlightdetail');
itouren.mlightdetail = function(){
	var _this = {
...
$(function(){
	   itouren.mlightdetail.init();
	   itouren.mlightdetail.copyUrl();
	   //itouren.lightdetail.printff();
	 //  itouren.lightdetail.addFavorite();
	   var url = qqFriend();  
       $("#qq_id").attr("href",url); 
});
