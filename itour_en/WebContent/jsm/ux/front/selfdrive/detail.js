$package('itouren.mselfdrivedetail');
itouren.mselfdrivedetail = function(){
	var _this = {
								...
								if(responseText.success){
									...
									$(data).each(function(i,e){
										...
										html+='<table width="63%" border="0" cellpadding="2" cellspacing="2" class="STYLE126">'+
							              ...
							              '<tr>'+
							              	'<td>&nbsp;</td>' +
							                '<td style="text-align:left"> '+(e.content?e.content:"")+'</td>'+
								              '</tr>'+
								              '<tr>'+
								                '<td>&nbsp;</td>'+
...
$(function(){
	   itouren.mselfdrivedetail.init();
	   itouren.mselfdrivedetail.copyUrl();
	   var url = qqFriend();  
       $("#qq_id").attr("href",url); 
});
