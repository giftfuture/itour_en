var YDataGrid = function(config){
		...
		//Win 窗口
		var Win =  {edit:$("#edit-photo")};// {edit:$("#edit-win")};
		var editWin = {edit:$("#edit-win")};
		//处理函数
		var Handler = {
			//serach 查询事件
			...
			edit:  function(callback){
				...
				editWin.edit.css("display","inline");
				var record = Utils.getCheckedRows();
				if (Utils.checkSelectOne(record)){
					itour.progress();
					var data ={};
		...
		var toolbarConfig = [bar_add,bar_edit,bar_remove,bar_upload];
